...
//	vncFrame.setBounds(-BORDER_WIDTH, -TITLE_HEIGHT, 
//		screenSize.width + 2*BORDER_WIDTH,
//		screenSize.height + TITLE_HEIGHT + BORDER_WIDTH);
	vncFrame.pack();
  ...
  void showConnectionStatus(String msg)
  {
    ...
    if (!vncContainer.isAncestorOf(connStatusLabel)) {
      ...
      gridbag3.setConstraints(connStatusLabel, gbc);
  ...
  String askPassword() throws Exception
  {
    ...
    gbc.ipadx = 100;
    gbc.ipady = 50;
    gridbag2.setConstraints(authPanel, gbc);
